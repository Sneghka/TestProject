...
namespace CWC.AutoTests.DataModel
{
    ...
    // WP_Contracts_PersonContract
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.33.0.0")]
    public class WP_Contracts_PersonContractConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<WP_Contracts_PersonContract>
    {
        public WP_Contracts_PersonContractConfiguration()
            : this("dbo")
        {
        }

        public WP_Contracts_PersonContractConfiguration(string schema)
        {
            ToTable("WP_Contracts_PersonContract", schema);
            HasKey(x => x.id);
