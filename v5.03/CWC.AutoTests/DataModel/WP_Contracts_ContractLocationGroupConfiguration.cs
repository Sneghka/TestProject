...
namespace CWC.AutoTests.DataModel
{
    ...
    public class WP_Contracts_ContractLocationGroupConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<WP_Contracts_ContractLocationGroup>
    {
        public WP_Contracts_ContractLocationGroupConfiguration()
            : this("dbo")
        {
        }

        public WP_Contracts_ContractLocationGroupConfiguration(string schema)
        {
            ToTable("WP_Contracts_ContractLocationGroup", schema);
            HasKey(x => x.id);
