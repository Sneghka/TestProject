...
namespace CWC.AutoTests.DataModel
{
    ...
    public class WP_CashCenter_HeaderCardConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<WP_CashCenter_HeaderCard>
    {
        public WP_CashCenter_HeaderCardConfiguration()
            : this("dbo")
        {
        }

        public WP_CashCenter_HeaderCardConfiguration(string schema)
        {
            ToTable("WP_CashCenter_HeaderCard", schema);
            HasKey(x => x.id);
