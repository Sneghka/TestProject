...
namespace CWC.AutoTests.DataModel
{
    ...
    public class WP_Contracts_ContractProductSettingConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<WP_Contracts_ContractProductSetting>
    {
        public WP_Contracts_ContractProductSettingConfiguration()
            : this("dbo")
        {
        }

        public WP_Contracts_ContractProductSettingConfiguration(string schema)
        {
            ToTable("WP_Contracts_ContractProductSettings", schema);
            HasKey(x => x.id);
            ...
            Property(x => x.PreDefinedQuantity).HasColumnName(@"PreDefinedQuantity").HasColumnType("int").IsOptional();
            Property(x => x.Product_code).HasColumnName(@"Product_code").HasColumnType("nvarchar").IsRequired().HasMaxLength(10);
            Property(x => x.ContractOrderingSettings_id).HasColumnName(@"ContractOrderingSettings_id").HasColumnType("int").IsRequired();
            Property(x => x.IsFixedContent).HasColumnName(@"IsFixedContent").HasColumnType("bit").IsRequired();
