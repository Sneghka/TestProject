...
namespace CWC.AutoTests.DataModel
{
    ...
    public class WP_Contracts_ContractLocationInGroupLinkConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<WP_Contracts_ContractLocationInGroupLink>
    {
        public WP_Contracts_ContractLocationInGroupLinkConfiguration()
            : this("dbo")
        {
        }

        public WP_Contracts_ContractLocationInGroupLinkConfiguration(string schema)
        {
            ToTable("WP_Contracts_ContractLocationInGroupLink", schema);
            HasKey(x => x.id);
            ...
            Property(x => x.ContractLocationGroup_id).HasColumnName(@"ContractLocationGroup_id").HasColumnType("int").IsRequired();
