...
namespace CWC.AutoTests.DataModel
{
    ...
    public class WP_Contracts_ScheduleSettingConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<WP_Contracts_ScheduleSetting>
    {
        public WP_Contracts_ScheduleSettingConfiguration()
            : this("dbo")
        {
        }

        public WP_Contracts_ScheduleSettingConfiguration(string schema)
        {
            ToTable("WP_Contracts_ScheduleSetting", schema);
            HasKey(x => x.id);
            ...
            Property(x => x.PeriodStartDate).HasColumnName(@"PeriodStartDate").HasColumnType("datetime").IsRequired();
        }
    }
