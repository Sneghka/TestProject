...
namespace CWC.AutoTests.DataModel
{
    ...
    public class Cwc_Contracts_PriceLineUnitsRangeConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Cwc_Contracts_PriceLineUnitsRange>
    {
        public Cwc_Contracts_PriceLineUnitsRangeConfiguration()
            : this("dbo")
        {
        }

        public Cwc_Contracts_PriceLineUnitsRangeConfiguration(string schema)
        {
            ToTable("Cwc_Contracts_PriceLineUnitsRange", schema);
            HasKey(x => x.id);
            ...
            Property(x => x.UnitsFrom).HasColumnName(@"UnitsFrom").HasColumnType("decimal").IsRequired().HasPrecision(18,2);
            Property(x => x.UnitsTo).HasColumnName(@"UnitsTo").HasColumnType("decimal").IsRequired().HasPrecision(18,2);
