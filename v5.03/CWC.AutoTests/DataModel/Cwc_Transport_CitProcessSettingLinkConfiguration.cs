...
namespace CWC.AutoTests.DataModel
{
    ...
    // Cwc_Transport_CitProcessSettingLink
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.33.0.0")]
    public class Cwc_Transport_CitProcessSettingLinkConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Cwc_Transport_CitProcessSettingLink>
    {
        public Cwc_Transport_CitProcessSettingLinkConfiguration()
            : this("dbo")
        {
        }

        public Cwc_Transport_CitProcessSettingLinkConfiguration(string schema)
        {
            ToTable("Cwc_Transport_CitProcessSettingLink", schema);
            HasKey(x => x.id);
