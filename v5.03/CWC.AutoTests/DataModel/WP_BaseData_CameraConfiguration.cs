...
namespace CWC.AutoTests.DataModel
{
    ...
    public class WP_BaseData_CameraConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<WP_BaseData_Camera>
    {
        public WP_BaseData_CameraConfiguration()
            : this("dbo")
        {
        }

        public WP_BaseData_CameraConfiguration(string schema)
        {
            ToTable("WP_BaseData_Camera", schema);
            HasKey(x => x.id);
            ...
            Property(x => x.CctvIpAddress).HasColumnName(@"CctvIpAddress").HasColumnType("nvarchar").IsOptional().HasMaxLength(255);
            Property(x => x.CctvPort).HasColumnName(@"CctvPort").HasColumnType("int").IsOptional();
