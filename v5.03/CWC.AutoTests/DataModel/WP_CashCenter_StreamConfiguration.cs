...
namespace CWC.AutoTests.DataModel
{
    ...
    public class WP_CashCenter_StreamConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<WP_CashCenter_Stream>
    {
        public WP_CashCenter_StreamConfiguration()
            : this("dbo")
        {
        }

        public WP_CashCenter_StreamConfiguration(string schema)
        {
            ToTable("WP_CashCenter_Stream", schema);
            HasKey(x => x.id);
            ...
            Property(x => x.StockOwner_id).HasColumnName(@"StockOwner_id").HasColumnType("int").IsRequired();
            ...
            Property(x => x.DestinationLocationID).HasColumnName(@"DestinationLocationID").HasColumnType("numeric").IsOptional().HasPrecision(15,0);
