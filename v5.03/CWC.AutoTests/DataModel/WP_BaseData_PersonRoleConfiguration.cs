...
namespace CWC.AutoTests.DataModel
{
    ...
    public class WP_BaseData_PersonRoleConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<WP_BaseData_PersonRole>
    {
        public WP_BaseData_PersonRoleConfiguration()
            : this("dbo")
        {
        }

        public WP_BaseData_PersonRoleConfiguration(string schema)
        {
            ToTable("WP_BaseData_PersonRole", schema);
            HasKey(x => x.id);
