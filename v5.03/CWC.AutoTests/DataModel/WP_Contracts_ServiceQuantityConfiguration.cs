...
namespace CWC.AutoTests.DataModel
{
    ...
    public class WP_Contracts_ServiceQuantityConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<WP_Contracts_ServiceQuantity>
    {
        public WP_Contracts_ServiceQuantityConfiguration()
            : this("dbo")
        {
        }

        public WP_Contracts_ServiceQuantityConfiguration(string schema)
        {
            ToTable("WP_Contracts_ServiceQuantity", schema);
            HasKey(x => x.id);
