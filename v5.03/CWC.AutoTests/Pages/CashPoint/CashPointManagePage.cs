...
{
    public class CashPointManagePage : ViewPage
    {
        public CashPointManagePage(IWebDriver driver) : base(driver)
        {
            this.PageUrl += "Solutions/CashPoint/Frames/CashPointsFrame.aspx";
        }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridCoinMachinesCtrl_lblHeaderCtrl")]
        public IWebElement ManagePageHeader { get; set; }        

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridCoinMachinesCtrl_GridDataViewCtrl_PagerBarB_FirstButton_B")]
        public override IWebElement FirstBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridCoinMachinesCtrl_GridDataViewCtrl_PagerBarB_PrevButton_B")]
        public override IWebElement PrevBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridCoinMachinesCtrl_GridDataViewCtrl_PagerBarB_NextButton_B")]
        public override IWebElement NextBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridCoinMachinesCtrl_GridDataViewCtrl_PagerBarB_LastButton_B")]
