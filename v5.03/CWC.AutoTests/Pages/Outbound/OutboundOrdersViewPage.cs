...
namespace CWC.AutoTests.Pages.Outbound
{
    ...
    public class OutboundOrdersViewPage : ViewPage
    {
        public OutboundOrdersViewPage(IWebDriver driver) : base(driver)
        {
            this.PageUrl += "Solutions/CashCenter/Frames/OutboundOrdersFrame.aspx";
        }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridOutboundOrdersCtrl_lblHeaderCtrl")]
        public IWebElement OutboundOrdersViewHeader { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_btnCreateOutboundOrder_B")]
        public IWebElement CreateBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_btnLinkToBatchCtrl_B")]
        public IWebElement LinkToBatchBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_btnUnlinkFromBatch_B")]
        public IWebElement UnlinkFromBatchBtn { get; set; }
        ...
        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridOutboundOrdersCtrl_GridDataViewCtrl_PagerBarB_FirstButton_B")]
        public override IWebElement FirstBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridOutboundOrdersCtrl_GridDataViewCtrl_PagerBarB_PrevButton_B")]
        public override IWebElement PrevBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridOutboundOrdersCtrl_GridDataViewCtrl_PagerBarB_NextButton_B")]
        public override IWebElement NextBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridOutboundOrdersCtrl_GridDataViewCtrl_PagerBarB_LastButton_B")]
        public override IWebElement LastBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridOutboundOrdersCtrl_GridDataViewCtrl_LPV")]
