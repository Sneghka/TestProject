...
namespace CWC.AutoTests.Pages.Outbound
{
    ...
    public class OutboundContainersPage : ViewPage
    {
        public OutboundContainersPage(IWebDriver driver) : base(driver)
        {
            this.PageUrl += "Solutions/CashCenter/Frames/OutboundContainersFrame.aspx";
        }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridContainersInPackingCtrl_lblHeaderCtrl")]
        public IWebElement OutboundContainersHeader { get; set; }
        ...
        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridContainersInPackingCtrl_GridDataViewCtrl_PagerBarB_FirstButton_B")]
        public override IWebElement FirstBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridContainersInPackingCtrl_GridDataViewCtrl_PagerBarB_PrevButton_B")]
        public override IWebElement PrevBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridContainersInPackingCtrl_GridDataViewCtrl_PagerBarB_NextButton_B")]
        public override IWebElement NextBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridContainersInPackingCtrl_GridDataViewCtrl_PagerBarB_LastButton_B")]
        public override IWebElement LastBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridContainersInPackingCtrl_GridDataViewCtrl_LPV")]
