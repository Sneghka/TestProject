...
{
    public class ReBillingPage : ViewPage
    {
        public ReBillingPage(IWebDriver driver) : base(driver)
        {
            this.PageUrl += "Solutions/Billing/Frames/ReBillingLinesFrame.aspx";
        }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridBillingLinesCtrl_lblHeaderCtrl")]
        public IWebElement ReBillingLinesHeader { get; set; }
