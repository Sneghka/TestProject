...
namespace CWC.AutoTests.Pages.Stock
{
    ...
    public class StockTransactionsPage : ViewPage
    {
        public StockTransactionsPage(IWebDriver driver) : base(driver)
        {
            this.PageUrl += "Solutions/CashCenter/Frames/StockTransactionsViewFrame.aspx";
        }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridStockTransactionsCtrl_lblHeaderCtrl")]
        public IWebElement StockTransactionsHeader { get; set; }
        ...
        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridStockTransactionsCtrl_GridDataViewCtrl_PagerBarB_FirstButton_B")]
        public override IWebElement FirstBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridStockTransactionsCtrl_GridDataViewCtrl_PagerBarB_PrevButton_B")]
        public override IWebElement PrevBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridStockTransactionsCtrl_GridDataViewCtrl_PagerBarB_NextButton_B")]
        public override IWebElement NextBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridStockTransactionsCtrl_GridDataViewCtrl_PagerBarB_LastButton_B")]
        public override IWebElement LastBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridStockTransactionsCtrl_GridDataViewCtrl_LPV")]
