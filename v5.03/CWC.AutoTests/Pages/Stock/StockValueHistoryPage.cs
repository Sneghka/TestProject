...
namespace CWC.AutoTests.Pages.Stock
{
    ...
    public class StockValueHistoryPage : ViewPage
    {
        public StockValueHistoryPage(IWebDriver driver) : base(driver)
        {
            this.PageUrl += "Solutions/CashCenter/StockManagement/Frames/StockValueHistoryViewFrame.aspx";
        }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridStockValueHistoryViewCtrl_lblHeaderCtrl")]
        public IWebElement StockValueHistoryHeader { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphTopMenu_searchCtrl_btnSearchCtrl_B")]
        ...
        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridStockValueHistoryViewCtrl_GridDataViewCtrl_PagerBarB_FirstButton_B")]
        public override IWebElement FirstBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridStockValueHistoryViewCtrl_GridDataViewCtrl_PagerBarB_PrevButton_B")]
        public override IWebElement PrevBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridStockValueHistoryViewCtrl_GridDataViewCtrl_PagerBarB_NextButton_B")]
        public override IWebElement NextBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridStockValueHistoryViewCtrl_GridDataViewCtrl_PagerBarB_LastButton_B")]
        public override IWebElement LastBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridStockValueHistoryViewCtrl_GridDataViewCtrl_LPV")]
