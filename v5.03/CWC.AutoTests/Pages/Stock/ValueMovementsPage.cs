...
namespace CWC.AutoTests.Pages.Stock
{
    ...
    public class ValueMovementsPage : ViewPage
    {
        public ValueMovementsPage(IWebDriver driver) : base(driver)
        {
            this.PageUrl += "Solutions/CashCenter/Frames/ValueMovementsViewFrame.aspx";
        }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridValueMovementsViewCtrl_lblHeaderCtrl")]
        public IWebElement ValueMovementsHeader { get; set; }
        ...
        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridValueMovementsViewCtrl_GridDataViewCtrl_PagerBarB_FirstButton_B")]
        public override IWebElement FirstBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridValueMovementsViewCtrl_GridDataViewCtrl_PagerBarB_PrevButton_B")]
        public override IWebElement PrevBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridValueMovementsViewCtrl_GridDataViewCtrl_PagerBarB_NextButton_B")]
        public override IWebElement NextBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridValueMovementsViewCtrl_GridDataViewCtrl_PagerBarB_LastButton_B")]
        public override IWebElement LastBtn { get; set; }

        [FindsBy(How = How.Id, Using = "ctl00_cphCR_gridValueMovementsViewCtrl_GridDataViewCtrl_LPV")]
